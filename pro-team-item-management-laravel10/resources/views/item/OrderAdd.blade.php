                ...
                <form method="POST" action="/item/OrderStore">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="p_stock" name="p_stock" value="{{ old('p_stock') }}">
                            @error('p_stock')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="p_date" name="p_date" value="{{old('p_date')}}">
                            @error('p_date')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="p_order" value="{{\Auth::user()->id}}">{{\Auth::user()->name}}
                            @error('p_order')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
